...
Функционал: проверка открытия форма справочников и документов

Как Тестировщик я хочу
выполнить быструю проверку открытия форм справочников и документов

Контекст:
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий

*Проверка открытия форма справочников
Сценарий: проверка открытия форма справочников
...
*Проверка открытия форм документов
Сценарий: Проверка открытия форм документов
